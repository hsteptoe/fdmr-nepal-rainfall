...
nepal_subset2 <- spTransform(nepal_subset, CRS("+init=epsg:8857"))
```
...
fdmr::model_viewer(model_output = fit, mesh = mesh, measurement_data = nepal_subset, data_distribution = "Gaussian")
